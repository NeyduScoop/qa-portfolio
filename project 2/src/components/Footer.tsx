    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Kana Azibabari Lagalo</h3>
            <p className="text-gray-400 mb-4">Building quality and security into technology — from idea to execution.</p>
            <div className="flex space-x-4">
              <a href="https://github.com/azibabari" target="_blank" rel="noopener noreferrer" className="footer-link">
                <Github size={20} />
              </a>
              <a href="https://www.linkedin.com/in/azibabari-kana-2749b7215" target="_blank" rel="noopener noreferrer" className="footer-link">
                <Linkedin size={20} />
              </a>
              <a href="mailto:kanaazibabari@gmail.com" className="footer-link">
                <Mail size={20} />
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© {currentYear} Kana Azibabari Lagalo. All rights reserved.</p>
